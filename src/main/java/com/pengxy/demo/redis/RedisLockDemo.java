...
public class RedisLockDemo {
    ...
    public static void main(String[] args) throws InterruptedException {
        // TimeUnit unit;
        ThreadPoolExecutor pool = new ThreadPoolExecutor(inventory, inventory, 10L, TimeUnit.SECONDS, linkedBlockingQueue);
        ...
        for(int i = 0 ; i <= NUM ;i++){
            ...
            System.out.println("共计耗时"+(endTime - startTime)+"，此时库存数为"+ inventory);
        }
    }
}
